    ...
    <div className={classes.hero}>
      ...
      <small
        ...
        style={{
          ...
          display: showCursorText ? 'block' : 'none',
        }}
      >
        Click me!
      </small>
      ...
      <h5>
        Now, I am working at{' '}
        <LinkInline label={'GammaUX'} href={'https://www.gammaux.com/en/'} /> as
        a Senior Design System Designer for{' '}
        <LinkInline label={'HP'} href={'https://www.hp.com/us-en/home.html'} />.
      </h5>
    </div>
  )
}
