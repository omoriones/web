...
export const Header: React.FC<HeaderProps> = ({ level }) => {
  ...
  return (
    <div className={classes.header}>
      {level === 'homepage' ? (
        <LinkHeader label="Olivier Moriones" href="/" />
      ) : (
        <LinkHeader
          href="/"
          iconSrc="src/assets/icons/arrow-left.svg"
          alt="Go back icon"
        />
      )}
      ...
      <div className={classes.headerOptions}>
        ...
        {theme !== 'light' ? (
          <LinkHeader
            ...
            onClick={toggleTheme}
            alt="Toggle icon to set light mode"
          />
        ) : (
          <LinkHeader
            href=""
            iconSrc="src/assets/icons/sun.svg"
            onClick={toggleTheme}
            alt="Toggle icon to set dark mode"
          />
        )}
      </div>
    </div>
