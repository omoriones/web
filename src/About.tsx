...
function About() {
  return (
    <>
      ...
      <Comment title="Simple" text="Less is more. Always." />
      ...
      <Title title="What I'm learning from this amazing journey" />

      <Comment title="Do what you want" text="It's the only way to be happy." />
